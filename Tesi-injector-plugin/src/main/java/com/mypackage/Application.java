...
//        args[4] = "nomeTag";
        ...
        try {
            ...
            commmandList.add(0,"cd /home/runner/work/A2-Spotify/A2-Spotify/test-hooks/test-guard");
            ...
            try{
                ...
                pb.command("bash", "-c", "bash /home/runner/work/A2-Spotify/A2-Spotify/Tesi-injector-plugin/target/hookInjection.sh");
                Process p = pb.start();
                p.waitFor();
